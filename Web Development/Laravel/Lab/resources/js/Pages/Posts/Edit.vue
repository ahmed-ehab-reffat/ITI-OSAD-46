...
const form = useForm({
    _method: 'PUT',
    title: props.post.raw_title || props.post.title,
    description: props.post.raw_description || props.post.description,
    owner_id: props.post.owner_id,
    image: null,
    tags: props.post.tag_names || '',
});
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div v-if="post.image_url">
                                ...
                                <img
                                    ...
                                    class="mt-2 h-32 w-auto rounded-lg shadow-sm"
                                />
                            </div>

                            <!-- New Image -->
                            <div>
                                <InputLabel for="image" value="Upload New Image (.jpg, .png)" />
                                <input
                                    id="image"
                                    type="file"
                                    accept=".jpg,.png"
