...
app.get(
  ...
  (req, res, next) => {
    const { id } = req.body;
    const item = controller.getItem(id);
...
app.post(
  ...
  (req, res, next) => {
    ...
    const addedItem = controller.addItem(name, quantity, category);
...
app.delete(
  ...
  (req, res, next) => {
    const deletedItem = controller.removeItem(req.body.id);
...
app.patch(
  ...
  (req, res, next) => {
    ...
    const success = controller.restockItem(id, amount);
...
app.patch(
  ...
  (req, res, next) => {
    const { id, amount } = req.body;
    const success = controller.destockItem(id, amount);
